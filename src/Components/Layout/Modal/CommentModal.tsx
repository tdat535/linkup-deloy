  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 backdrop-blur-sm bg-black/80 p-4 md:p-6">
      ...
      >
        ...
        {post.image && (
          <div
            className={`w-full h-64 md:h-auto md:w-1/2 flex items-center justify-center p-2 
          ...
          >
            {/\.(jpeg|jpg|gif|png|bmp|webp)$/i.test(post.image) ? (
              <img
                src={post.image}
                alt="Post content"
        ...
        >
          ...
          >
            <div
              className={`flex items-center gap-3 rounded-full border overflow-hidden pr-2
                          ${
                            isDark
