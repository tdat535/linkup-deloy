    ...
    setMessages((prev) => [
      ...prev,
      {
        ...
        sender: {
          ...
          isOnline: true, // Assuming the current user is online
        },
      },
    ]);
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-center">
                      ...
                      {/* Hiển thị thời gian khi có tin nhắn cuối cùng */}
                    ...
                    {/* Hiển thị nội dung tin nhắn cuối cùng nếu có */}
                    {conv.lastMessage && (
              ...
              {messages.map((msg, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Placeholder khi không hiển thị avatar */}
                    {!isCurrentUser && !showAvatar && (
                    ...
                    {/* Avatar cho người dùng hiện tại */}
                    {isCurrentUser && showAvatar && (
                      <img
                        className="w-8 h-8 rounded-full object-cover mb-1"
